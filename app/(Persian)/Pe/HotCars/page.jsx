...
const HotCars = async () => {
  ...
  <div className=' flex flex-col items-end justify-start gap-y-2.5 text-black-100'>
      <h1 className='text-2xl font-extrabold md:text-6xl text-right' >   ماشین های <span className='text-shadow-3d-subtle'>پرطرفدار</span>  </h1>
      <p className='md:text-xl mt-8 mb-12 w-[700px] text-sm text-[#777777] text-right max-md:w-full'>در این بخش، شما می‌توانید با جدیدترین و پرطرفدارترین خودروهای روز آشنا شوید که طرفداران زیادی در دنیای خودرو دارند. این خودروها به دلیل طراحی منحصر به فرد، ویژگی‌های فنی پیشرفته و محبوبیت در بازار، در صدر توجهات قرار دارند. اگر به دنبال خودرویی هستید که توجه همه را جلب کند و تجربه‌ای متفاوت از رانندگی را برای شما فراهم کند، اینجا محل مناسبی است!</p>
    </div>
