...
import {  CarCardtwo } from '@/components'

import React, { useState } from 'react'
import { useGettingCars } from '@/hook/hooks'


const Cars = () => {
  const [Cars , Loading] = useGettingCars()
  const [pageNum , setPageNum] = useState(1)
  const slicedCars = Cars.slice((pageNum *8)-8,pageNum * 8)


  
  return (<section className='flex flex-col min-h-[100vh] overflow-auto '>
    ...
    {Loading  
          ...
          ? (<div className="flex items-center justify-center h-[60vh]"><div className="w-16 h-16 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div></div>) 
          
          :     (<section className='ml-6 max-md:ml-0  py-10 ' >
