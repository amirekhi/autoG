...
const PECarDetails = ({ isOpen, closeModal, car , ImageUrls}) => (
  <>
            ...
            >
              <Dialog.Panel className='relative w-full max-w-xl max-h-[90vh] overflow-x-hidden overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                ...
                >
                 ...
                 {ImageUrls &&  <div className='flex-1 flex flex-col gap-3'>
                ...
                <div className='flex-1 flex flex-col gap-2'>
                  ...
                  <div className='mt-3 flex flex-wrap gap-4'>
                    {Object.entries(car).map(([key, value]) => {
                        ...
                        return (
                              <div className='flex justify-between gap-5 w-full text-right flex-row-reverse' key={key} >
